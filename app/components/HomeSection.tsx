...
import { slideInFromLeft, slideInFromRight, slideInFromTop } from "@/ultis/motion";
  ...
  return (
    ...
    className="w-full h-auto pb-20 relative">
      ...
      <div className=" content section items-center flex-row justify-center mt-24">
        ...
        <motion.div
          variants={slideInFromLeft(0.75)} className="mt-8 text-gray-400">
        ...
        <motion.div
          variants={slideInFromRight(0.75)}className="sm:flex hidden items-center justify-center -z-10">
      ...
      <div className="mt-12 grid sm:grid-cols-4 grid-cols-2 sm:gap-12 gap-4">
      <motion.div
